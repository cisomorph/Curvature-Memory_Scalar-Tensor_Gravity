...
(ii)~RIFT CMB power spectrum computed via full CLASS Boltzmann solver deviates from $\Lambda$CDM by RMS~$= 2.93\%$ ($\ell=2$--1500), with gravitational growth ratio $D_{\mathrm{RIFT}}/D_{\Lambda\mathrm{CDM}} = 1.000000$ ($G_{\mathrm{eff}}/G = 1-16\,\mathrm{ppm}$ at $\Lambda_0=0.003$);
