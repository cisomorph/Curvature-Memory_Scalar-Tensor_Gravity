...
At the coupling strength $\Lambda_0 = 0.003$ tested here, RIFT is cosmologically
indistinguishable from $\Lambda$CDM at the CMB+BAO level ($G_{\mathrm{eff}}/G = 1 - 16\,\mathrm{ppm}$).
The observational signature of RIFT is therefore expected primarily at non-linear
scales (structure formation, sigma-8, galaxy cluster counts, void statistics) and at
higher coupling or in strong-field regimes. Future simulations will:
\begin{enumerate}
  ...
  \item Compute sigma-8 and non-linear P(k) from RIFT structure formation;
