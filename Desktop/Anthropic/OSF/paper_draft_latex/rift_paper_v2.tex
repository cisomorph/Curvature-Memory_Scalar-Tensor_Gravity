...
\begin{enumerate}
  \item \textbf{BAO-only fit:} LCDM achieves $\chi^2/\mathrm{dof} = 13.6/10 = 1.36$
        ...
        ($z=0.51$ DH/r_d: $-2.5\sigma$; $z=0.71$ DM/r_d: $-2.0\sigma$),
...
\begin{itemize}
  ...
  \item Observational consistency (Sims~87--94): BAO $\chi^2/\mathrm{dof} = 1.22$ (BOSS, Sim~87), $1.36$ (DESI Y1, Sim~94); CMB RMS deviation $= 2.93\%$; joint CMB+BAO $\Delta\chi^2 = 0$ (both datasets); $\sigma_8$ unmodified at $|\Delta\sigma_8| < 0.007\%$ at $\Lambda_0 = 0.003$.
...
\begin{enumerate}
  ...
  \item Extend CMB constraints to polarization (EE, TE) via full CLASS Boltzmann;
