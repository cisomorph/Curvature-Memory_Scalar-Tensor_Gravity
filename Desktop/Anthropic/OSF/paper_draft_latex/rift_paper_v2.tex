...
We subject RIFT to twelve independent precision cosmological tests (Sims~87--98).
The key results are:
...
$\Lambda$CDM at current precision. The recursive field coupling $\Lambda_0$ is
constrained to $\Lambda_0 < 0.095$ (95\% CL) by the Bayesian analysis and is
cosmologically inert at current observational precision. Falsifiable predictions
