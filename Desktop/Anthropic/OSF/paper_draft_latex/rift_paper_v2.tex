...
We subject RIFT to fourteen independent tests (Sims~87--100).
The key results are:
...
\begin{itemize}
  ...
  \item UV regulation conjecture---recursive memory damping \emph{suggests} improved UV behaviour, but no loop calculation has been performed and finiteness of the interacting theory remains unproven (Section~\ref{sec:quantization}).
