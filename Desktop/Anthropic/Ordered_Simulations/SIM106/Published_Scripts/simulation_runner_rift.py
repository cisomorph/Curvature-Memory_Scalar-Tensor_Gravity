...
print("  - Lambda0 RG flow: asymptotically free (SIM105)")
print("  - Two-loop graviton diagrams: FINITE (SIM106)")
print("  The last explicit UV caveat is now closed.")
print("  The RIFT theory is UV-finite at one loop and through the two-loop")
...
diag = {
    ...
    "conclusion": (
        ...
        "RIFT UV-finite through two-loop graviton sector under Dyson resummation. "
