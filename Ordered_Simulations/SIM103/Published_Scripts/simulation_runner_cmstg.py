"""
SIM103 — CMSTG Vainshtein Screening and Dark Matter Mechanism
============================================================
Tests whether a nonlinear kinetic term (Vainshtein mechanism) allows the CMSTG
...
Lambda0     = P['cmstg_params']['Lambda0']
m0          = P['cmstg_params']['m0_kpc_inv']
Psi0        = P['cmstg_params']['Psi0_cosmo']
...
diag = {
    ...
    'verdict': {
        ...
        'conclusion': (
            ...
            'constraints. '
            'Conclusion: CMSTG cannot replace dark matter through any kinetic modification '
