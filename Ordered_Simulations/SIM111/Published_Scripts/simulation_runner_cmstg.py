...
SIM109 found that with m₀ = 0.001 H₀ (slow-roll), CMSTG predicts
...
def run_m0(m0, verbose=False):
    """
    Integrate CMSTG background for given m₀.
...
if best_fine is not None:
    ...
    print(f"  w₀ (CMSTG)  = {bf['w0']:+.4f}")
    print(f"  wₐ (CMSTG)  = {bf['wa']:+.4f}")
    print()
