...
def run():
    print("=" * 72)
    print("SIM114 — Phase 2 CMSTG: βΨ²ρ_m condensate, galactic rotation curves")
    print("=" * 72)
    print(f"  Λ₀      = {LAMBDA0}")
    ...
    diag = {
        'sim': 'SIM114',
        'description': 'Phase 2 CMSTG DM: beta*Psi^2*rho_m condensate galactic rotation curves',
        'Lambda0': LAMBDA0,
        'lambda_cosmo': LAM_CO,
        'lambda_kpc': LAM_KPC,
        'v_ssb': V_SSB,
...
def _make_figures(r_s, diag):
    ...
    fig.suptitle('SIM114 — Phase 2 CMSTG: β Condensate Rotation Curves (NGC3198)', fontsize=13)
