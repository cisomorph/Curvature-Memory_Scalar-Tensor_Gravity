#!/usr/bin/env python3
"""
SIM115: Phase 2 — Gradient Soliton DM (most-CMSTG approach)
...
Most-CMSTG alternative (this sim): the Λ₀R suppression in dense regions IS the DM mechanism.
...
This is CMSTG-natural because:
  1. The Λ₀ΨR coupling (CMSTG's defining term) creates the dip — geometry sources field
...
def run():
    print("=" * 72)
    print("SIM115 — Phase 2 CMSTG: Gradient Soliton DM (most-CMSTG approach)")
    print("=" * 72)
    print(f"  Λ₀       = {LAMBDA0}")
