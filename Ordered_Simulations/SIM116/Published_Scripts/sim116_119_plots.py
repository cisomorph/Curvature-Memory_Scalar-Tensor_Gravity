...
# ═══════════════════════════════════════════════════════════════════════════════
# SIM118 — CMSTG-seeded fuzzy χ DM: best-fit rotation curve + results
# ═══════════════════════════════════════════════════════════════════════════════
...
fig.suptitle('SIM118 — CMSTG-seeded Fuzzy χ DM (NGC 2403): PARTIAL', fontsize=13, y=1.01)
fig.tight_layout()
for ext in ['pdf', 'png']:
...
ax.text(0.97, 0.97,
        ...
        f"CMSTG link: $m_\\chi=\\sqrt{{2\\kappa}}\\bar\\Psi$  [PASS]",
        transform=ax.transAxes, ha='right', va='top', fontsize=9,
        bbox=dict(boxstyle='round', fc='#d9f0d3', alpha=0.9))

fig.suptitle('SIM119 — SPARC-wide CMSTG Fuzzy χ DM: PASS', fontsize=13, y=1.01)
fig.tight_layout()
for ext in ['pdf', 'png']:
