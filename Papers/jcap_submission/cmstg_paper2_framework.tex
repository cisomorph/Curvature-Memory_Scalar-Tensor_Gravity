...
\subsection{Planck Likelihood Evaluation (SIM98)}
\label{sec:joint}

\paragraph{Method.} The joint CMB+BAO parameter optimum was located by SIM90
using a Gaussian prior on the $(H_0, \Omega_m)$ marginal extracted from the
Planck~2018 chains~\cite{Planck2018}; the methodologically definitive CMB
likelihood evaluation at this optimum is reported below using the full
Planck~2018 plikHM TTTEEE likelihood (SIM98).
...
An earlier evaluation at the BAO-only best-fit parameters (SIM97,
$H_0 = 68.14$~km/s/Mpc, $\Omega_m = 0.294$) gave
$\Delta(-2\ln\mathcal{L}) = +7.0$; this is superseded by SIM98 at the
joint optimum, which is the methodologically appropriate comparison point.
...
the joint best-fit cosmology, not as EE/TE tensions.
