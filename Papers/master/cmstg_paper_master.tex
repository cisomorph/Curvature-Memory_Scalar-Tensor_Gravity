...
Twenty-Two Observational Tests, and No-Go Theorems\\[4pt]
\large\textit{Master Compilation: Papers~I--IV}}
...
(xxiii)~no-go theorems I and II (Sims~131--136, SIM141--143, Phase~3/4): thirteen
    mechanism tests across the full Tier~2 extension space (Horndeski kinetic,
    Gauss-Bonnet, bi-scalar, Galileon $G_3$, running $\Lambda_0(a)$) confirm that
    no covariant single-field extension of the Phase~1 locked action can reduce
    the $2.77\sigma$ DESI~Y1 BAO residual without raising $H(z)$ in
    $z\in[0,z_{\rm rec}]$ and thereby shifting the CMB acoustic angle
...
(xxiv)~Galileon $G_3$ (Sim~142): the Galileon kinetic coupling $G_{3,X}$ is
    ...
    route and exhausts the Tier~2 mechanism space.
...
\paragraph{Phase 3/4 no-go results (SIM131--143).}
Phases~3 and~4 (SIM112--SIM143) were devoted entirely to the question of whether
the $2.77\sigma$ DESI~Y1 residual is reducible within the \CMSTG\ action class.
Thirteen mechanism tests across the Tier~2 extension space --- Horndeski kinetic
extensions, Gauss-Bonnet coupling, bi-scalar double field, Galileon $G_3$ kinetic
term, and running $\Lambda_0(a)$ --- all returned FAIL.  The structural analysis
yields two no-go theorems:
...
The Galileon $G_3$ route (Sim~142) was eliminated by a new structural result:
$G_{3,X}=0$ exactly in the slow-roll attractor because $\dot\Psi^2/M^3 \ll 1$
at cosmological field amplitudes.  The $2.77\sigma$ DESI~Y1 residual is a
\emph{structural prediction} of the Phase~1 locked action.  The decisive
experimental test is DESI~Y3.
...
Planck/KiDS $\sigma_8$ tension. The three open directions identified at
the end of Phase~4 are: (1)~first-principles $\Psi$--baryon coupling for
galactic predictions; (2)~DESI~Y3 BAO analysis once data are public;
...
All simulation scripts, outputs, and JSON diagnostic files (SIM82--SIM143) are
