...
Gravity (\CMSTG). We establish two complementary structural no-go theorems
that together prove the Phase~1 canonical action is the unique covariant
...
Planck bound at more than $30\sigma$. Thirteen simulation-based mechanism
tests (SIM131--SIM136, SIM141--SIM143, plus two structural arguments)
verify both theorems exhaustively across the identified Tier~2 mechanism
space. The $2.77\sigma$ DESI~Y1 residual is therefore a structural
...
It is UV-finite through two loops with an explicit asymptotic freedom fixed
point at $\Lz=0$ (Paper~III of this series~\cite{WilsonPaperIII}). Its one
