...
to within $0.21\%$. This validates the integration pipeline against the
standard result; the remaining offset reflects the difference between our SIM90
cosmological parameters ($H_0 = 67.59$, $\Omega_m = 0.312$) and the Planck~2018
best-fit, together with the simplified single-fluid Friedmann equation.
