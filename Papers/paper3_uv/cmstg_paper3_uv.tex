...
\begin{enumerate}
  ...
  \item \textbf{$\Lz$ fixed point (SIM105).} The beta function
    ...
    GR limit) and no infrared Landau pole. The mechanism is distinct from
    standard asymptotic freedom: $\km$ is a fixed input of the theory rather
    than a running coupling, and the flow describes the probe-scale sensitivity
    of $\Lz$ below the memory scale.
