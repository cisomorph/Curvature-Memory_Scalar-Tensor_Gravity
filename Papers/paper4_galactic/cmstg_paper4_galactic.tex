...
against DESI~Y1 BAO that is irreducible within the action class by any late-time
mechanism (Paper~I~\cite{WilsonPaperI}). This paper establishes the
...
the dark-energy boundary of the framework (Paper~I~\cite{WilsonPaperI}). The
...
in a useful way: just as Paper~I identified the curvature-sourcing route and
the $H(z)$-boost route as the two mechanism classes available for late-time
modifications, the three options below identify the position-dependent mass
