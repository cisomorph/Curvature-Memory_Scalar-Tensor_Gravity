...
We subject RIFT to twelve independent observational tests (Sims~87--98).
The key results are:
...
\begin{itemize}
  ...
  \item Extended tests (Sims~107--111): Solar System ($|\gamma-1|=1.78\times10^{-5}$, PASS), GW speed ($c_T=c$ exactly, 6/6 PASS), dark energy equation of state ($w_0=-0.992$, 3.6$\sigma$ DESI tension), $m_0$ scan (minimum achievable DESI tension $3.44\sigma$; locked action structurally cannot resolve DESI hint; unlocking required).
\end{itemize}
