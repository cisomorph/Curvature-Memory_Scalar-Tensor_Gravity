"""
SIM102 — RIFT One-Loop Scalar Self-Energy: UV Structure and Memory Regulation
=============================================================================
...
Modified graviton propagator:
  D_RIFT(k) = exp(-2k^2/k_m^2) / k^2   [factor of 2 from two vertices]
...
Actually the memory damping enters the GRAVITON propagator, not the vertex separately:
  D_RIFT(k) = D_mem(k)^2 / k^2 = exp(-2k^2/k_m^2) / k^2

So:
  Sigma(p^2) = Lambda0^2 * Int d^4k/(2pi)^4 * [k^2]^2 * D_RIFT(k) / ((p-k)^2 + m0^2)
...
# ── Main computation ─────────────────────────────────────────────────────────
print("=" * 60)
print("SIM102 — RIFT One-Loop Scalar Self-Energy")
print("=" * 60)
