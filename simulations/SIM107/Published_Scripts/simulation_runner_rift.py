...
Derives the Psi-matter coupling from the linearised RIFT field equation,
...
# ─── RIFT Parameters (observationally constrained) ────────────────────────────
...
# ─── 2. Scalar Coupling Strength (from linearised RIFT action) ────────────────
def alpha_coupling(Psi0):
    """
    Effective dimensionless scalar-matter coupling alpha for PPN.

    From varying RIFT action: the Psi-matter vertex comes from
...
# ─── MAIN ─────────────────────────────────────────────────────────────────────
print("="*70)
print("SIM107: RIFT Matter-Psi Coupling and Solar System Viability")
print("="*70)
...
if overall == "PASS":
    print("RIFT satisfies Solar System fifth-force constraints.")
    ...
    print("RIFT violates Solar System constraints.")
