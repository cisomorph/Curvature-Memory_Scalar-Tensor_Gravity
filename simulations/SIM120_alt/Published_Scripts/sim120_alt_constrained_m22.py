#!/usr/bin/env python3
"""
SIM120-alt — RIFT Phase 2: Constrained Universal m₂₂ SPARC Fit
================================================================
...
and derives κ from the RIFT DE-DM link: m_χ = √(2κ)Ψ̄.
...
# RIFT DE parameters (locked from SIM113)
...
def kappa_from_m22(m22, Psi_bar_Mpl=Psi_bar):
    """κ from RIFT link m_χ = √(2κ)·Ψ̄ with m_χ = m₂₂ × 10⁻²² eV / M_Pl."""
    m_chi_eV = m22 * 1e-22
...
if __name__ == '__main__':
    print("=" * 72)
    print("SIM120-alt — RIFT Phase 2: Constrained Universal m₂₂ SPARC Fit")
    print("=" * 72)
    print(f"\n  Soliton virial: A = {soliton_A:.2e} M_sun kpc, I_sol = {I_sol:.5f}")
    print(f"  RIFT DE link: Ψ̄ = {Psi_bar} M_Pl  (SIM113 best-fit)")
    ...
    # ── κ derivation ────────────────────────────────────────────────────────────
    print("\n─" * 72)
    print("PART F: RIFT κ derivation")
    print("─" * 72)
    ...
    if PASS:
        ...
        print("  constraint imposed. The RIFT DE-DM link κ = m_χ²/(2Ψ̄²) is")
