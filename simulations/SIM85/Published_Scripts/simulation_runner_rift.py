#!/usr/bin/env python3
# Sim 85 — RIFT FLRW Friedmann Test
"""
Numerically integrate the full RIFT FLRW system and verify the derived
...
def integrate_model(Lambda_fn, dLambda_fn, label):
    """
    Integrate RIFT FLRW equations using RK4 in ln(a) as independent variable.
