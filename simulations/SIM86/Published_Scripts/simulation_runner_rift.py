#!/usr/bin/env python3
# Sim 86 — RIFT Observer Field (Self-Consistent Back-Reaction)
"""
Tests the closed RIFT loop: Psi -> R -> Psi.

In the full RIFT system, Psi is sourced by R through the retarded kernel
...
The "observer field" interpretation: in RIFT, an observer is a region
...
diag = {
    "description": (
        ...
        "Tests attractor stability of the closed RIFT loop."
    ),
    "params": P,
    "results": all_results,
    "interpretation": {
